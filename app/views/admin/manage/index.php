                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($lists as $list) { ?>
                        <tr>
                            ...
                            <td class="center ">
                                <a class="btn btn-warning" href="index.php?c=manage&m=reject&id=<?php echo $list['list_id'] ?>">
                                    <i class="halflings-icon white repeat"></i>
                                </a>
                                <a class="btn btn-danger" href="index.php?c=manage&m=delete&id=<?php echo $list['list_id'] ?>">
