...
<?php include '/../include/sidebar.php'; ?>
    ...
    <div class="box span12">
        <div class="box-header" data-original-title="">
            <h2><i class="halflings-icon white edit"></i><span class="break"></span>Create new User</h2>
        </div>
            ...
            <form class="form-horizontal" action="" method="post">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge" id="focusedInput" name="user_first_name" type="text" value="">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge" id="focusedInput" name="user_last_name" type="text" value="">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-xlarge" id="focusedInput" name="user_email" type="text" value="">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="user_admin_status" value="1" >Make user admin<br>
                        </div>
                    </div>
                </fieldset>
                <div class="form-actions">
                    <button type="submit" name="user_create" class="btn btn-primary">Create</button>
