        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    <a href="index.php?c=admins&m=create" class="glyphicons-icon user_add pull-right"></a>
                    <table class="table table-striped">
                        <thead>
                        <tr role="row">
                            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0"
                                rowspan="1" colspan="1" aria-sort="ascending"
                                aria-label="Username: activate to sort column descending" style="width: 181px;">Username
                            </th>
                        ...
                        <tr>
                            <td class="  sorting_1"><?php echo $admin->getAdminUsername(); ?></td>
                            <td class="center ">
                                <a class="btn btn-danger" href="index.php?c=admins&m=delete&id=<?php echo $admin->getAdminId(); ?>">
